...
,'roadway_intersection_approach':"""
    ...
    ,TOTAL_TAXIS INT NULL
    ,TOTAL_GOVERNMENT INT NULL
    ,SPEEDING_INVOLVED VARCHAR NULL
    ,NEARESTINTROUTEID VARCHAR NULL
    ,NEARESTINTSTREETNAME VARCHAR NULL
    ,OFFINTERSECTION VARCHAR NULL
    ,INTAPPROACHDIRECTION VARCHAR NULL
    ...
    ,UNKNOWNINJURIESPASSENGER INT NULL
    ,geometry geometry
    ,PED_INJURIES INT NULL
    ,BICYCLE_INJURIES INT NULL
    ,VEHICLE_INJURIES INT NULL
    ,TOTAL_INJURIES INT NULL
    ,OOS_VEHICLES INT NULL
    ,DRIVERS_UNDER_25 INT NULL
    ,DRIVERS_OVER_80 INT NULL
    ,PEDS_OVER_70 INT NULL
    ,PEDS_UNDER_12 INT NULL
    ,BIKERS_OVER_70 INT NULL
    ,BIKERS_UNDER_12 INT NULL
    ,CARS INT NULL
    ,SUVS_OR_TRUCKS INT NULL
    ,DRIVER_TICKETS INT NULL
    ,BICYCLE_TICKETS INT NULL
    ,PED_TICKETS INT NULL
    ,DRIVERS_SPEEDING INT NULL
    ,PERSONTYPE TEXT[] NULL
    ,INVEHICLETYPE TEXT[] NULL
    ,LICENSEPLATESTATE TEXT[] NULL
"""
    }
